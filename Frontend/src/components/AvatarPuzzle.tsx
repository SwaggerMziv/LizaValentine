...
export function AvatarPuzzle({ stage, title, description, photoUrls, sessionId, onComplete, onFlash }: AvatarPuzzleProps) {
      ...
      <div className="space-y-4">
        {photoUrls.map((url, i) => (
          <motion.img
            ...
            src={url}
            alt="Аватарка"
            className="w-32 h-32 rounded-full mx-auto border-2 border-neon-purple"
        ...
        {!solved && (
          <div className={shaking ? "animate-shake" : ""}>
            <Input
              ...
              placeholder="Фамилия на аватарке..."
              className="font-mono"
            />
          </div>
        )}
