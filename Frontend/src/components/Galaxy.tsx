...
export default function Galaxy({
  ...
  // Store dynamic props in refs so the animation loop reads latest values
  const propsRef = useRef({ starSpeed, disableAnimation, speed });
  useEffect(() => {
    propsRef.current = { starSpeed, disableAnimation, speed };
  }, [starSpeed, disableAnimation, speed]);

  // Init effect — creates WebGL context once, never recreated
  useEffect(() => {
  ...
  }, [density, hueShift, speed, glowIntensity, saturation, mouseRepulsion, twinkleIntensity, rotationSpeed, repulsionStrength, autoCenterRepulsion]);
